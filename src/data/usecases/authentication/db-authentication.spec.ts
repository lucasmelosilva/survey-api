...
import type { AuthenticationModel, HashComparer, LoadAccountByEmailRepository, Encrypter, UpdateAccessTokenRepository, UpdateModel } from './db-authentication-protocols'
...
const makeUpdateAccessTokenRepositoryStub = (): UpdateAccessTokenRepository => {
  class UpdateAccessTokenRepositoryStub implements UpdateAccessTokenRepository {
    async updateAccessToken (updateModel: UpdateModel): Promise<void> {
...
describe('DbAuthentication UseCase', () => {
  ...
  it('should call UpdateAccessTokenRepository with correct values', async () => {
    ...
    await sut.auth(makeFakeAuthentication())
    expect(updateSpy).toHaveBeenCalledWith({ id: 'valid_id', accessToken: 'any_token' })
  })
})
